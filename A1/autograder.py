...
def test_goal_fn():
    ...
    for i in range(0,len(GOALS)):
        s0 = GOALS[i]
    #print(get_board(s0.get_vehicle_statuses(), s0.get_board_properties()))
...
def test_fval_function_XDP():
    ...
    for i in range(len(weights)):
        ...
        fval = fval_function_XDP(test_node, weights[i])
...
def test_fval_function_XUP():
    ...
    for i in range(len(weights)):
        ...
        fval = fval_function_XUP(test_node, weights[i])
...
if __name__=='__main__':
    ...
    #test_fval_function_XDP()
    #test_fval_function_XUP()
    #test_mindist()
    #test_alternate_fun()
